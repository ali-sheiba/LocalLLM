...
- **Run ID:** `20260819T195658Z-avuja-qwen3-8-27b-int4-autoround-4f0a879b`
- **Status:** `failed`
- **Started:** `2026-08-19T19:54:23.150743+00:00`
- **Finished:** `2026-08-19T20:22:01.593730+00:00`
...
| Compose environment file | `models/qwen3.8-27b/autoround-int4/profiles/avuja-01-gpu-util-0.94.env` |
| Environment SHA-256 | `7e766a316dcd11f50fa0a89707ef6886809f2502ba600bbcc4dd2b26d9819d93` |
...
|---:|---:|---:|---:|---:|---:|
| 0 | 1 | 68.68 | 68.68 | 1138.61 | 1955.83 |
| 0 | 2 | 77.25 | 38.62 | 1715.51 | 1800.88 |
| 8,192 | 1 | 62.41 | 62.41 | 6332.37 | 1641.90 |
| 8,192 | 2 | 29.28 | 14.64 | 9508.66 | 1619.43 |
| 32,768 | 1 | 49.38 | 49.38 | 28277.69 | 1235.63 |
| 32,768 | 2 | 9.21 | 4.60 | 44067.60 | 1235.97 |
...
```sh
uv run --extra perf tool-eval-bench run --seed 42 --base-url http://localhost:8080 --model qwen3.8-27b --json-file /tmp/localllm-bench-panys2mk/quality.json --output-dir /tmp/localllm-bench-panys2mk/upstream-reports --no-live
```
