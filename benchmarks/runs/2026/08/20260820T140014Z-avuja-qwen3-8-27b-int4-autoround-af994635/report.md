...
- **Run ID:** `20260820T140014Z-avuja-qwen3-8-27b-int4-autoround-af994635`
- **Status:** `completed`
- **Started:** `2026-08-20T13:55:08.776666+00:00`
- **Finished:** `2026-08-20T14:16:46.582305+00:00`
...
| Benchmark profile | `avuja-09-mtp-3-fp8-prefix.env` |
| Compose environment file | `models/qwen3.8-27b/autoround-int4/profiles/avuja-09-mtp-3-fp8-prefix.env` |
| Environment SHA-256 | `0d646b3102481bc88a6881fd782b0e80b3a45ec8f7f0a75adec83f01dc5ecb6a` |
...
|---:|---:|---:|---:|---:|---:|
| 0 | 1 | 82.81 | 82.81 | 1636.03 | 1334.67 |
| 0 | 2 | 50.96 | 25.48 | 3283.85 | 836.43 |
| 8,192 | 1 | 84.96 | 84.96 | 8393.89 | 1235.63 |
| 8,192 | 2 | 21.35 | 10.67 | 13452.22 | 1107.95 |
| 32,768 | 1 | 68.57 | 68.57 | 30152.74 | 1158.86 |
| 32,768 | 2 | 7.66 | 3.83 | 45936.69 | 1128.83 |
...
```sh
/home/app/.local/bin/uv run --extra perf tool-eval-bench run --seed 42 --base-url http://localhost:8080 --model qwen3.8-27b --json-file /tmp/localllm-bench-hoypzpek/quality.json --output-dir /tmp/localllm-bench-hoypzpek/upstream-reports --no-live
```
