...
- **Run ID:** `20260820T174124Z-avuja-qwen3-8-27b-int4-autoround-212a7a5d`
- **Status:** `completed`
- **Started:** `2026-08-20T17:41:24.470565+00:00`
- **Finished:** `2026-08-20T17:58:15.985482+00:00`
...
| Host model path | `Avuja/Qwen3.8-27B-int4-AutoRound` |
...
|---:|---:|---:|---:|---:|---:|
| 0 | 1 | 92.52 | 92.52 | 1730.18 | 1233.61 |
| 0 | 2 | 65.00 | 32.50 | 2603.32 | 1187.04 |
| 8,192 | 1 | 86.90 | 86.90 | 8791.09 | 1174.81 |
| 8,192 | 2 | 66.89 | 33.44 | 16672.88 | 1168.55 |
| 32,768 | 1 | 64.15 | 64.15 | 31402.53 | 1111.45 |
| 32,768 | 2 | 8.61 | 4.31 | 49318.55 | 1105.63 |
...
```sh
/home/app/.local/bin/uv run --extra perf tool-eval-bench run --seed 42 --base-url http://localhost:8080 --model qwen3.8-27b --json-file /tmp/localllm-bench-qwfvcocw/quality.json --output-dir /tmp/localllm-bench-qwfvcocw/upstream-reports --no-live
```
