# Benchmark Run — MKRWW/Qwen3.8-27B-int4-AutoRound

- **Run ID:** `20260819T184714Z-mkrww-qwen3-8-27b-int4-autoround-21dd0010`
- **Status:** `completed`
- **Started:** `2026-08-19T18:42:08.719269+00:00`
- **Finished:** `2026-08-19T19:03:29.193155+00:00`
- **Protocol:** `tool-eval-69-perf-v1`
- **Comparison key:** `MKRWW/Qwen3.8-27B-int4-AutoRound\|tool-eval-69-perf-v1\|NVIDIA GeForce RTX 3090,NVIDIA GeForce RTX 3090`

## Model and Stack

| Field | Value |
|---|---|
| Hugging Face source | `MKRWW/Qwen3.8-27B-int4-AutoRound` |
| Host model path | `/home/app/models/MKRWW/Qwen3.8-27B-int4-AutoRound` |
...
| Compose environment file | `models/qwen3.8-27b/autoround-int4/profiles/mkrww.env` |
| Environment SHA-256 | `8f82b00ef4660b345acc635a573ba96730a3334ed8a06aa150640e36e35bf34b` |
...
| Safety & Boundaries | 73 | 19 | 26 | 8 / 3 / 2 |
...
|---:|---:|---:|---:|---:|---:|
| 0 | 1 | 68.64 | 68.64 | 1144.32 | 1948.98 |
| 0 | 2 | 76.99 | 38.49 | 1726.48 | 1789.26 |
| 8,192 | 1 | 62.37 | 62.37 | 6349.00 | 1638.07 |
| 8,192 | 2 | 29.22 | 14.61 | 9521.89 | 1616.95 |
| 32,768 | 1 | 49.34 | 49.34 | 28253.35 | 1236.75 |
| 32,768 | 2 | 8.68 | 4.34 | 44085.13 | 1235.57 |
...
```sh
uv run --extra perf tool-eval-bench run --seed 42 --base-url http://localhost:8080 --model qwen3.8-27b --json-file /tmp/localllm-bench-okwr9g9a/quality.json --output-dir /tmp/localllm-bench-okwr9g9a/upstream-reports --no-live
```
