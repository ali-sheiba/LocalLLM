...
- **Run ID:** `20260820T084730Z-avuja-qwen3-8-27b-int4-autoround-781666d6`
- **Status:** `completed`
- **Started:** `2026-08-20T08:45:04.714737+00:00`
- **Finished:** `2026-08-20T09:04:29.430069+00:00`
...
| Compose environment file | `models/qwen3.8-27b/autoround-int4/profiles/avuja-02-prefill-16384.env` |
| Environment SHA-256 | `b263d5676cd098c84b226856ee20592e96f4fff060f7296a73f6842d2400e1df` |
...
|---:|---|---:|---:|---|
| 0 | NVIDIA GeForce RTX 3090 | 350.00 W | 24576 MiB | Gen 1 ×16 |
| 1 | NVIDIA GeForce RTX 3090 | 350.00 W | 24576 MiB | Gen 1 ×16 |
...
|---:|---:|---:|---:|---:|---:|
| 0 | 1 | 68.56 | 68.56 | 1328.37 | 1656.35 |
| 0 | 2 | 73.05 | 36.52 | 1972.72 | 1567.86 |
| 8,192 | 1 | 62.36 | 62.36 | 7213.38 | 1438.98 |
| 8,192 | 2 | 26.75 | 13.37 | 10773.39 | 1431.81 |
| 32,768 | 1 | 49.35 | 49.35 | 31559.10 | 1106.80 |
| 32,768 | 2 | 10.78 | 5.39 | 51543.10 | 1127.05 |
...
```sh
/home/app/.local/bin/uv run --extra perf tool-eval-bench run --seed 42 --base-url http://localhost:8080 --model qwen3.8-27b --json-file /tmp/localllm-bench-kl0ghsh9/quality.json --output-dir /tmp/localllm-bench-kl0ghsh9/upstream-reports --no-live
```
